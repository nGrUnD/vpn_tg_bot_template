...
BUY_STARS_TARIFFS_CAPTION = (
    "👑 <b>Полный доступ</b>\n\n"
    "Выберите тариф в Telegram Stars⬇️:"
)
...
def buy_stars_payment_caption(amount_stars: int) -> str:
    n = int(amount_stars)
    legal = buy_legal_links_block()
    return (
        "<b>Оплата Telegram Stars</b>\n\n"
        f"Сумма к оплате: <b>{n}</b> ⭐️\n\n"
        "1. Нажмите кнопку «Оплатить звёздами».\n"
        "2. Подтвердите оплату в Telegram.\n"
        "3. После оплаты придёт уведомление; при необходимости нажмите «Проверить оплату».\n\n"
        f"{legal}"
    )
...
STARS_VERIFY_NONE = "Платёж в Stars не найден. Откройте экран оплаты заново через «Купить доступ»."
STARS_VERIFY_PENDING = "Оплата в Stars ещё не подтверждена. Если вы уже оплатили, подождите немного и нажмите ещё раз."
STARS_VERIFY_PAID = "Оплата звёздами получена — открываю ваши подключения."
STARS_VERIFY_PROVISIONING = "Оплата звёздами есть, но подписка ещё создаётся. Попробуйте ещё раз через несколько секунд."
STARS_VERIFY_PROVISION_FAILED = "Оплата звёздами есть, но подписку пока не удалось создать. Попробую ещё раз."
